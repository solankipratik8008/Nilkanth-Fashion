...
import { Save, Upload, Plus, Trash2, Eye, Play, Image as ImageIcon, Instagram, Facebook, Twitter, Youtube } from 'lucide-react';
...
const TABS = ['homepage', 'media', 'navigation', 'footer', 'about & contact', 'testimonials', 'faqs'];
